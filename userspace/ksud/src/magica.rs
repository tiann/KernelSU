...
pub fn disable_adb_root() -> Result<()> {
    ...
    info!("Restoring: resetprop --delete service.adb.root");
    let _ = rp.delete("service.adb.root");

    info!("Restoring: resetprop --delete service.adb.tcp.port");
    let _ = rp.delete("service.adb.tcp.port");
