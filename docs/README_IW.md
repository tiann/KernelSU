...
KernelSU כבר לא מקבל תרומות תרגום דרך Weblate. כל התרגומים מנוהלים כעת באמצעות LLMs.

אם ברצונך להוסיף תמיכה בשפה חדשה, אפשר לפתוח PR. שים לב שלא מתקבלות עריכות לתרגומים הקיימים באנגלית ובסינית.
