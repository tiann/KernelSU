...
KernelSU больше не принимает вклад в переводы через Weblate. Теперь все переводы выполняются с помощью LLM.

Если вы хотите добавить поддержку нового языка, смело открывайте PR. Обратите внимание, что изменения в существующих английском и китайском переводах не принимаются.
