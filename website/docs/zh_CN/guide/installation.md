...
::: warning
请务必做好这一步再进行下一步操作！！必要时你还可以备份你手机的所有数据。
:::
...
KMI 全称 Kernel Module Interface，相同 KMI 的内核版本是**通用的** 这也是 GKI 中“通用”的含义所在；反之，如果 KMI 不同，那么这些内核之间无法互相兼容，刷入与你设备 KMI 不同的内核镜像可能会导致死机。
...
2. 使用某些 PC 上的刷机工具箱刷入 KernelSU 提高的内核。